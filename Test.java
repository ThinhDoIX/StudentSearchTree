public class Test {
    ...
    public static void main(String[] args) {
        ...
        treeBST.createTree_Random();
        treeBST.nlr();

        System.out.println("So luong sinh vien: " + treeBST.size());
        treeBST.findMinMax();
